...
const App: React.FC = () => {
  ...
  const whatsappText = encodeURIComponent("Hello Smart 3T Construction, I am interested in your engineering services.");
  ...
  return (
    <div className="min-h-screen">
      ...
      <a 
        ...
        className="fixed bottom-8 right-8 z-[150] w-16 h-16 bg-[#25D366] text-white rounded-full shadow-2xl flex items-center justify-center transition-all hover:brightness-110 active:scale-95 animate-pulse-whatsapp group"
